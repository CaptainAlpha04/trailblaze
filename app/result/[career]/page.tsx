...
const Page = async () => {
  ...
  if (innerWidth < 786) {
   return ( 
    <section>
      {!data ? <Loading />:
      <div className="min-h-screen min-w-screen py-20 px-5 font-mono flex flex-wrap gap-5 text-base-content">

        <div className="card w-screen h-fit bg-base-200 shadow-xl font-mono">
