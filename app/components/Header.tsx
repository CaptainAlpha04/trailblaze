...
function Header() {
  return (
    <header className="navbar fixed top-0 z-10 bg-base-200 flex-1 justify-between max-w-full text-base-content">
      <Link href="/">
        <h1 className="btn btn-ghost text-xl font-mono">
          🔥TrailBlaze</h1>
      </Link>
      <div>
        <button className="btn btn-outline font-mono mr-2 hover: btn-accent">
        Donate! ❤️
        </button> 
        <button className="btn bg-base-100 text-xl justify-end mr-4">
